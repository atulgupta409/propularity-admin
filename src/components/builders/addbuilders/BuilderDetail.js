...
const BuilderDetail = () => {
  ...
  useEffect(() => {
    if (Object.values(editBuilder).length > 0 && isBuilderEditable) {
      setBuilder({
        name: editBuilder.name,
        slug: editBuilder.slug,
        starting_price: editBuilder.starting_price,
        configuration: editBuilder.configuration,
        ratings: editBuilder.ratings,
        estb_year: editBuilder.estb_year,
        residential_num: editBuilder.residential_num,
        commercial_num: editBuilder.commercial_num,
        coming_soon: editBuilder.coming_soon,
      });
    } else {
      setBuilder({
        name: "",
